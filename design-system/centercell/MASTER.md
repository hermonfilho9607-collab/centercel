...
|---|---|---|---|
| `--fundo` | `#071B0D` | próximo do verde-escuro mais amostrado (`#031905`–`#073C07`) | fundo da página |
...
| `--texto-no-whatsapp` | `#06210F` | — | **texto escuro sobre o verde do WhatsApp** — ver nota de contraste abaixo |
...
**Archivo Expanded** (700/800, títulos) + **Archivo** (400–700, texto) — uma
...
| Seção nova | — | **Como funciona** (4 passos: diagnóstico → orçamento → reparo → entrega) |
| Loja | lista + 1 foto grande | **grid de 5 categorias** (cards, sem depender de foto) |
